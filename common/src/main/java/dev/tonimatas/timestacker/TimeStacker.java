...
public class TimeStacker {
	...
	public static boolean applyEffect(LivingEntity livingEntity, MobEffectInstance mobEffectInstance, Entity entity) {
		...
		ResourceLocation resourceLocation = Registry.MOB_EFFECT.getKey(mobEffectInstance.getEffect());
		
		if (resourceLocation == null) {
			return livingEntity.addEffect(mobEffectInstance);
		}
		
		boolean isBlacklisted = !config.getBlacklist().contains(resourceLocation.getNamespace() + ":" + resourceLocation.getPath());
